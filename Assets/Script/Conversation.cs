...
public class Conversation
{
    ...
    {//DiaryController    Crystal    CameraController 
        ...
        new Conversation("red", "流浪商店還真的是到處都有呢，\n這次還擺著一些奇怪的商品……"),
        new Conversation("crystal", "哇！有精靈餅乾耶！\n勇者大人，可以買給我嗎？"),
        new Conversation("red", "精靈餅乾？你餓了嗎？"),
        new Conversation("crystal", "有一點……\n不過主要是為了恢復力量喔！"),
        new Conversation("red", "恢復力量？"),
        new Conversation("crystal", "沒錯，為了逃離那個大塊頭消耗太多力量\n身體還受了傷，其實剛剛的魔法也被削弱了"),
        new Conversation("crystal", "不過只要有精靈餅乾\n我就能恢復魔力，魔法的威力就會越強喔！"),
        new Conversation("red", "感覺就像升級一樣……\n我想考慮一下"),
        new Conversation("crystal", "沒問題！那我先教你怎麼使用商店吧！"),
        new Conversation("crystal", "對商店按下『Z鍵 / Enter鍵』\n會出現裝備或道具的買賣視窗"),
        new Conversation("crystal", "只要點選想要購買或販賣的道具\n再選買入或賣出，就會購買或販賣道具"),
        new Conversation("crystal", "另外，商店也有儲存紀錄的功能\n只要點選保存紀錄就能儲存到目前為止的進度"),
        new Conversation("crystal", "很神奇對吧！\n看在我這麼努力解說的份上，能幫我買一片餅乾嗎？"),
